...
if __name__ == '__main__':
    ...
    train_loss1, accv1, model1 = mlp.sigmoid_NN_train_and_val(train_loader, validation_loader, 
                                                      lr=0.1, epochs=EPOCHS)
    train_loss2, accv2, model2 = mlp.sigmoid_NN_train_and_val(train_loader, validation_loader, 
                                                      lr=0.01, epochs=EPOCHS)
    train_loss3, accv3, model3 = mlp.sigmoid_NN_train_and_val(train_loader, validation_loader, 
                                                      lr=0.001, epochs=EPOCHS)
    train_loss4, accv4, model4 = mlp.sigmoid_NN_train_and_val(train_loader, validation_loader, 
